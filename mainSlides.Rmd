...
date: "Fall 2015 Workshop <br> <span style='color:#00274c'>Advanced Research Computing <br> Consulting for Statistics, Computation and Analytyics Research</span>"
output: 
...
6. group by **Region**  (<span class='func'>mutate</span>)
...
The packages using it typically are pipe-oriented and interactive.
...
<tr>
<td>Michael Clark <br> Advanced Research Computing <br> Consulting for Statistics, Computing & Analytics Research <br> University of Michigan
<br><br>
Seth Berry<br> Notre Dame Research<br> Center for Social Research<br> University of Notre Dame
</td>
