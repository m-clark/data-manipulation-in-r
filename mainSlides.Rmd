...
```{r, eval=TRUE, cache=TRUE, message=FALSE, echo=-1}
...
statsTabLong = statsTab %>% 
  ...
  gather(key = 'vitalInfo', value = 'value', -Tm) 
...
```{r long2wide, cache=TRUE, eval=FALSE}
## BROKEN AT PRESENT, HADLEY SOLUTION NOT VIABLE, EVAL FALSE FOR NOW
statsTabLong %>%
