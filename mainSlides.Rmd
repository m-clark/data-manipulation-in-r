...
As is often the case, there are times when we want to calculate new variables based upon existing ones.
...
statsTab %<>% mutate_each(funs(as.numeric), -Player, -Pos, -Tm)
...
Sometimes, we have a lot of variables to select. If they have a common naming scheme (as they should), 
...
statsTab %>% 
  ...
  gather(key = 'vitalInfo', value = 'value', fieldGoalPerc, threePointPerc, twoPointPerc, 
