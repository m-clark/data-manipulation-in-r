...
Let's say we want to select the following from our data the following:
...
```{r wikileafletNoEval2, eval=FALSE}
  ...
  layout(title = 'Largest US cities and their 2010-2015 change <br>(Click legend to toggle)', 
...
- It serves as an illustration of what's possible.
    ...
    >- Key commands: mutate, select, filter
    >- Autocomplete for unquoted variable names
    >- Pipe to other functions (e.g. viz)
